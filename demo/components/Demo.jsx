    ...
    return (
      <div>
        ...
        <Grid>
          ...
          <ContentSwapper transitionName="wait-fade" transitionEnterTimeout={1000} transitionLeaveTimeout={1000}>
          ...
          <div style={{width: 600}}>
            <ContentSwapper transitionName="carousel-swap" className="carousel"
